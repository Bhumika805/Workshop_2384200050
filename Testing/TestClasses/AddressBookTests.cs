...
namespace Testing.TestClasses
{
    public class AddressBookTests
    {
        ...
        {
            // Arrange
            var request = new AddressBookRequestDTO
            {
                UserId = 1,
                Name = "John Doe",
        ...
        public void GetAllContacts_ReturnsContactList()
        {
            ...
            {
                new AddressBookEntry { Id = 1, Name = "John Doe", Email = "john@example.com", PhoneNumber = "1234567890", Address = "123 Main St" },
                new AddressBookEntry { Id = 2, Name = "Jane Doe", Email = "jane@example.com", PhoneNumber = "0987654321", Address = "456 Oak St" }
            };
